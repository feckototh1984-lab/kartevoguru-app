...
export default function WorkOrderDocument({
  ...
  return (
    <main className="min-h-screen bg-slate-100 px-3 py-4 print:bg-white print:px-0 print:py-0">
      ...
      <div className="pdf-scroll-shell overflow-x-auto">
        <div className="pdf-scroll-inner mx-auto min-w-[794px] max-w-[794px]">
                  ...
                  <div className="grid gap-6 md:grid-cols-2 print-grid-2 avoid-break">
                    <section className="rounded-2xl border border-slate-200 bg-white p-5">
                      ...
                      <div className="space-y-2.5">
                        <p>
                          <span className="font-bold">Szolgáltató:</span>{' '}
                          KártevőGuru
                        </p>
                        <p>
                        ...
                        <p>
                          <span className="font-bold">Telefon:</span> +36 30 602
                          0650
                        </p>
                        <p>
                        ...
                        <p>
                          <span className="font-bold">Székhely / cím:</span>{' '}
                        ...
                        <p>
                          <span className="font-bold">Adószám:</span>{' '}
                          91094722-1-34
                        </p>
                        <p>
